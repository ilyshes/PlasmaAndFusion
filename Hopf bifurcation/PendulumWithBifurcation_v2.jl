...
q = 1.3  # different damping coefficients to observe bifurcation
...
for n in N_plot_start:4:n_iter₁ - 10
    ...
    # Set the legend position
     ...
     savefig("img/2/res_$(@sprintf("%05d", idx_plot)).png")
end 
